...
export default function MainMenuBar({ onMenuClick, hasTrajectory }: MainMenuBarProps) {
  const menuItems: MenuProps['items'] = [
    ...
    { key: 'db', icon: <DatabaseOutlined />, label: 'БД СБИ', children: [
      ...
      { type: 'divider' },
      { key: 'db-compare', label: 'Сравнение БД' },
      { key: 'db-update', label: 'Обновить БД' },
      { key: 'db-export', label: 'Экспорт БД' },
      { key: 'db-check', label: 'Проверить БД' },
    ]},
    ...
    { key: 'view', icon: <EyeOutlined />, label: 'Вид', disabled: !hasTrajectory, children: [
    ...
    { key: 'graph', icon: <LineChartOutlined />, label: 'График', disabled: !hasTrajectory, children: [
    ...
    { key: 'tables', icon: <TableOutlined />, label: 'Таблицы', disabled: !hasTrajectory, children: [
      { key: 'table-values', label: 'Значения параметров' },
      { key: 'table-settings', label: 'Настройка таблицы' },
      { type: 'divider' },
      { key: 'table-export', label: 'Сохранить' },
      { key: 'table-print-preview', label: 'Предпросмотр печати' },
      { key: 'table-print', label: 'Печать' },
      { type: 'divider' },
    ...
    { key: 'processing', icon: <ToolOutlined />, label: 'Вторичная обработка', children: [
      ...
      { key: 'proc-tasks', label: 'Задачи', children: [
        { key: 'proc-task-list', label: 'Список задач' },
        { key: 'proc-task-load', label: 'Загрузить задание' },
        { key: 'proc-task-save', label: 'Сохранить задание' },
      ]},
